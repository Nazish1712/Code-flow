...
const Hero = () => {
    ...
    return (
        <section className="relative  min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden pb-5">
            ...
            <div className="max-w-7xl mx-auto text-center relative w-full">
                ...
                <div>
                    <div className="inline-flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700">
                        ...
                        <span className="text-xs sm:text-sm text-blue-300">Introducing UrbanStay</span>
                    </div>
                  ...
                  xl:text-6xl font-semibold mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700 delay-100 leading-tight">
                    ...
                    <span className="bg-gradient-to-b from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent block mb-1 sm:mb-2 ">Live Better</span>
                    <span className="bg-gradient-to-r from-white via-blue-100 to-cyan-100 bg-clip-text text-transparent block mb-1 sm:mb-2 ">With UrbanStay</span>
                  </h1>
                ...
                <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
                    <div className="bg-gradient-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[290px] sm:h-[450px] border border-white/5">
                        ...
                        <div className="flex space-x-2 items-center">
                           ...
                           <div>
                           <span className="text-xs font-semibold sm:text-sm text-gray-300">Urban</span>
                           <span className="text-xs font-semibold sm:text-sm text-blue-400">Stay</span>
                           </div>
                        ...
                        <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                            ...
                            className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${ activeTab === "Reserve" ? "bg-blue-500/30 text-white border-blue-400/20" : "bg-white/5 text-gray-300 border-white/10 hover:bg-white/10" } transition-all duration-200 whitespace-nowrap`}>Reserve</button>
                            <button  
