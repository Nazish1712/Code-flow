...
const HomeCard = ({cardData, isBooked, onDelete, className}) => {
    ...
    return(
       <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden hover:bg-white/10 hover:shadow-lg hover:ring-white/20 hover:shadow-blue-500/20 hover:-translate-y-1 transition-all duration-300 ease-in-out hover:ring-1">
        ...
        <div className="p-4 space-y-2">
          ...
          <div className="flex justify-between items-center">
          <button className={cn("flex justify-center items-center group px-3 sm:px-4 py-1 rounded-lg  bg-gradient-to-b from-blue-600 to-blue-400 font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-105 gap-2" ,className)}>
